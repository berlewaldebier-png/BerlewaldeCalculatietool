...
export type QuoteFormState = {
  ...
  introScopeAllProducts: boolean;
  introContractDurationMonths: string;
  introContractEndDate: string;
  ...
  introNote: string;
  staffelScopeAllProducts: boolean;
  ...
  mixProducts?: string;
  kortingScopeAllProducts: boolean;
  discountMode: string;
  discountValue: string;
  kortingEligibleRefs: string[];
  wholesaleScopeAllProducts: boolean;
  wholesaleEligibleRefs: string[];
  wholesaleMarginPct: string;
  wholesaleSameMarginAllProducts: boolean;
  wholesaleMarginsByRef: Record<string, string>;
  ...
  palletChargedToCustomer: boolean;
  ...
  transportFreeShippingThresholdUnit: "pallets" | "layers" | "boxes" | "fust" | "fles" | "liters" | "km" | "order_value";
  transportCostType: "fixed" | "per_km" | "manual";
