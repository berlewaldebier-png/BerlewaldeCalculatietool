...
def normalize_verkoopstrategie_product_record(record: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "strategie_type": strategie_type,
        "price_group": str(record.get("price_group", "") or ""),
        "price_list_name": str(record.get("price_list_name", "") or ""),
        ...
        "effective_to": str(record.get("effective_to", "") or ""),
        "updated_from": str(record.get("updated_from", "") or ""),
